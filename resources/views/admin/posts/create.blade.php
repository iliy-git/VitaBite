...
@section('title', 'Создание поста - VitaBite Admin')
@section('page-title', 'Создание нового поста')

@section('content')
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Заполните информацию о посте</h2>
        </div>
