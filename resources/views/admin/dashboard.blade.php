    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-700">Рецепты</h3>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-700">Опубликовано</h3>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-700">Черновики</h3>
                    <p class="text-2xl font-bold text-gray-900">
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <a href="{{ route('admin.posts.create') }}"
                       class="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg transition flex items-center justify-center">
                ...
                @if($recentPosts->count() > 0)
                    <div class="mt-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-3">Последние посты</h3>
                        <div class="space-y-2">
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <a href="{{ route('admin.recipes.create') }}"
                       class="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-4 rounded-lg transition flex items-center justify-center">
                        <i class="fas fa-plus mr-2"></i>
                ...
                @if($recentRecipes->count() > 0)
                    <div class="mt-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-3">Последние рецепты</h3>
                        <div class="space-y-2">
