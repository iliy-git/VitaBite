        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100">
            <div class="px-6 py-4 border-b border-gray-100">
                <div class="flex justify-between items-center">
                    <h2 class="text-lg font-medium text-gray-900">Все рецепты</h2>
                    <a href="{{ route('admin.recipes.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md transition-colors flex items-center">
            ...
            <div class="p-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Сложность</th>
                            ...
                            @foreach($recipes as $recipe)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex px-2 text-xs font-medium rounded-full bg-orange-100 text-orange-800">
                                        {{ $recipe->difficulty }}
                                    </span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs font-medium rounded-full {{ $recipe->is_published ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <a href="{{ route('admin.recipes.create') }}" class="inline-block mt-4 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md transition-colors">
